//! Module for creating log messages and sending to the desired target.
//! Log messages sent to the network will use the protocol specified in the [module@protocol] module.
